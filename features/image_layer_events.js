...
class ImageLayerEvents {
        ...
        this.layer.nameInput.addEventListener("change", (e) => {
            ...
            if (newFilename) {
                ...
                if (this.layer.filepath) {
                    ...
                    this.layer.filepath = require("path").join(dir, `${newFilename}.${ext}`);
                }
            }
        });
        // Color copy on click
    ...
    setupKeyboardShortcuts() {
        ...
        document.addEventListener("keydown", (e) => {
            if (document.activeElement !== this.layer.panel)
                return;
    ...
    setupCropping() {
        this.layer.canvas.addEventListener("mousedown", (e) => {
            ...
            if (!this.layer.modeManager.isCropping())
                return;
    ...
    setupMagnifying() {
        ...
        this.layer.canvas.addEventListener("mousemove", (e) => {
            ...
            this.layer.magnifyAnimationId = requestAnimationFrame(() => {
                ...
                this.layer.overlayCtx.drawImage(this.layer.image, sourceX, sourceY, sourceSize, sourceSize, mouseX - radius, mouseY - radius, magnifySize, magnifySize);
...
//# sourceMappingURL=image_layer_events.js.map