...
class GifAnimation {
  /**
   * @param {ImageLayer} layer - Reference to parent ImageLayer instance
   */
  constructor(layer) {
   ...
   * @param {Buffer} buffer - Original GIF buffer
   * @param {Object} metadata - GIF metadata (pages, delay, loop)
   */
   ...
   */
  isAnimated() {
    return this.metadata && this.metadata.pages > 1;
  }
