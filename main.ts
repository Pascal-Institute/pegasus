...
import { ContextMenuOptions, MenuItemConfig } from './types';
...
app.whenReady().then(() => {
  ...
  ipcMain.on('copy-image-to-clipboard', (event: IpcMainEvent, imageBuffer: Uint8Array) => {
    try {
